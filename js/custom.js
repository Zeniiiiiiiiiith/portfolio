(function($) {
    ...
    /* ----------------------------------------------------------- */
	/*  Stoppe la vidéo dans la section Portfolio
    /* ----------------------------------------------------------- */
...
$(window).on("load", function() {
    ...
    /* ----------------------------------------------------------- */
	/*  Permet de charger la page avant qu'elle ne soit affichée par le navigateur
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
	/*  Scroll Horizontal + Les Animations
    /* ----------------------------------------------------------- */
...
$(document).ready(function() {
    ...
    /* ----------------------------------------------------------- */
    /*  Fix pour les personnes qui utilisent Safari (j'ai pas vérifié si ça marche mais ça devrait le faire)
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
	/*  Enlèves les classes des animations en mode Bureau
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
	/*  Swiper pour la partie Portfolio
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
	/*  Swiper en mode Slider pour le Portfolio en mobile
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
	/*  Arrête la vidéo lorsqu'on change la slide
    /* ----------------------------------------------------------- */
